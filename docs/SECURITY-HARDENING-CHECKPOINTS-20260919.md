...
- [x] P0-04 CI dependency audit / lint / image audit / typecheck / build / rendered audits PASS
- [x] P0-05 Vercel Preview READY — `b8b0290` / `dpl_FvLdE1k1q26euKEN2URDDkQQUFdP`
